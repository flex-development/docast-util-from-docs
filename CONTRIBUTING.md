...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docast-util-from-docs
   cd docast-util-from-docs
   ```
...
```sh
https://github.com/flex-development/docast-util-from-docs/compare/main...$branch
```
...
[19]: https://github.com/flex-development/docast-util-from-docs/discussions/new?category=q-a
